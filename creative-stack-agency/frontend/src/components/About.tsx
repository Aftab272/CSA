...
export default function About() {
  return (
    <section id="about" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-primary text-white font-sans">
      <div className="max-w-7xl mx-auto space-y-14 sm:space-y-20">
        {/* Introduction & Story */}
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display text-white">We're More Than Just Developers</h2>
          ...
          <div className="bg-secondary border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl">
        ...
        <div className="space-y-12">
          <h3 className="text-2xl sm:text-3xl font-bold font-display text-center text-white">Our Core Values</h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {['Creativity', 'Innovation', 'Quality', 'Transparency', 'Client Satisfaction'].map((value, i) => (
              <div key={i} className="bg-secondary p-6 sm:p-8 rounded-2xl border border-white/5 shadow-lg hover:shadow-[0_0_20px_rgba(0,212,255,0.1)] transition">
        ...
        <div className="bg-secondary border border-white/10 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl">
          <h3 className="text-2xl sm:text-3xl font-bold font-display text-white mb-10 sm:mb-12 text-center">Professional Timeline</h3>
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="flex flex-col sm:flex-row gap-3 sm:gap-6 sm:items-center">
                <div className="text-accent font-bold text-lg sm:text-xl">{item.year}</div>
                <div className="h-0.5 w-full sm:grow bg-white/10"></div>
                <div>
