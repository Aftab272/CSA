      ...
      <div className="max-w-sm md:max-w-md lg:max-w-lg w-full">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h3 className="text-2xl md:text-4xl font-bold font-display text-gray-900 dark:text-white">{platform.name}</h3>
            <p className="text-gray-600 dark:text-gray-400 text-base md:text-xl">{platform.followers}</p>
            <a href={platform.url} className="relative overflow-hidden group/btn w-full py-3.5 md:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-full shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.6)] transition-all duration-300 transform hover:-translate-y-0.5 text-center flex items-center justify-center">
